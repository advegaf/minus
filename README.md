...
<p align="center">
  A digital minimalism app for iPhone. A giant clock, your intention, the few apps you actually need, and real app blocking through Apple's Screen Time API when you choose to focus.
</p>

<p align="center">
  <img src="docs/images/hero.png" width="960" alt="Three minus screens on the void: the home clock with five apps under it, a focus session counting down, and the schedules list">
</p>

<p align="center">
  <sub>Build it yourself. iPhone, iOS 26. No account, no network.</sub>
</p>
...
<table>
  <tr>
    <td><img src="docs/images/home-dark.png" alt="The home screen on the void"></td>
    <td><img src="docs/images/home-light.png" alt="The same home screen on paper"></td>
  </tr>
</table>
...
obsidian, white 3% off paper) so the mass recedes and the dispersion is the
...
Switzer, Cabinet Grotesk, Chillax, all Fontshare under the ITF Free Font
License),
...
The simulator always runs against `MockScreenTimeService`. Real shields go
through FamilyControls, which needs a physical device with dev signing.
...
Typefaces are [Fontshare](https://www.fontshare.com): General Sans, Satoshi,
Switzer, Cabinet Grotesk and Chillax, under the ITF Free Font License.
